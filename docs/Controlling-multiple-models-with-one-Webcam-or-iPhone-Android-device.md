...
![新建VTS进程按钮](img/img/start_new_vts_instance_button.png)
...
![网络服务器自动分配IP端口](img/img/network_server_auto_ip.png)
...
![VTube Studio多进程运行示意图](img/img/vtube_studio_multi_instance_1.png)
