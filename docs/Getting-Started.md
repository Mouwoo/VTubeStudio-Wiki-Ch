...
> *想要在VTS中建立VNet 多人联机，你必须先购买 [VNet DLC](https://store.steampowered.com/app/2384550/VTube_Studio__VNet_Multiplayer_Collab/).
...
如果你的模型未使用默认ID设置，那么你必须手动设置模型。手册页面上的 ["VTS 模型设置"](VTS-Model-Settings.md#vts) 对此进行了详细解释。
