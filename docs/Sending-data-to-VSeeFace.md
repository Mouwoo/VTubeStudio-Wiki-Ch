...
[[img/img/vseeface_setup_1.png|alt="VSeeFace Setup Part 1"|width=1024px]]

要想查看VSeeFace设置，你需要在主菜单中打开设置栏并下拉到第一栏的最底部。

设置界面如下：

[[img/img/vseeface_setup_2.png|alt="VSeeFace Setup Part 2"|width=512px]]
...
[[img/img/vseeface_setup_3.png|alt="VSeeFace Setup Part 3"|width=1100px]]
