...
[[img/img/tobii_tracker_img.png|alt="Tobii Eye Tracker 5"]]
...
[[img/img/tobii_basic.png|alt="Tobii Eye Tracker Setup"]]
...
4. 选择 `"Tobii Experience - 仅限测试版"`, 如何点击 `"下载驱动"` 安装 `"Tobii 驱动"`. 如果你不想安装测试版本, 选择 `"Tobii眼动追踪核心软件"` 安装 (但是你会失去头部追踪)。
5. 运行 `"Tobii 驱动"` ，确保它与你的设备配合良好并进行校准。
...
这是可能的， **但不推荐**。 Tobii 追踪器不支持眉毛/嘴巴等。因此，如果你单独使用 Tobii 跟踪器，你可能无法获得你想要的一般跟踪质量。
...
[[img/img/tobii_experience_eyes_on.png|alt="Tobii Eye Tracker Settings: Only track one eye"]]
