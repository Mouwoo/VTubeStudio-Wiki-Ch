...
[[img/img/live2d_api_editor_vts_2.png]]

## 如何设置

首先，你需要打开Live2D Cubism Editor API。点击`文件` => `外部应用程序的集成设置...` 然后点击播放键来开启API。

[[img/img/live2d_api_editor_1.png]]
...
[[img/img/live2d_api_editor_vts_1.png]]
...
[[img/img/live2d_api_editor_2.png]]
...
[[img/img/live2d_api_editor_vts_anim.png]]
