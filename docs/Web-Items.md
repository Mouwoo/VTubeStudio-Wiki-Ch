...
[[img/img/web_items_a.png|alt="VTube Studio Web Items"|width=792px]]
...
[[img/img/web_items_examples.png]]
...
<p float="left">
  <img src="img/img/web_items_item_scenes.gif" width="490" /> 
</p>
...
[[img/img/web_items_settings_a.png|width=613px]]
...
如果插件可以访问Web 挂件功能，它将被隐藏在附加 [许可](https://github.com/Mouwoo/VTubeStudio/tree/master/Permissions) 之后。
