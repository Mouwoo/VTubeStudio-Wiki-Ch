...
* 确保你的智能手机上的移动数据已关闭。如果它打开，可能会导致 VTube Studio 报告错误的 IP。
* 试着暂时关闭你的杀毒软件。
...
* 如果可以，请使用有线局域网连接代替WiFi，以体验无滞后、延迟少于1毫秒的连接效果。你可以靠适配器来在手机上使用有线局域网，比如 [这个适用于Android（USB-C）](https://www.amazon.com/dp/B0823CB5MT/) 或 [这个适用于iPhone/iPad](https://www.amazon.com/Lighting-Ethernet-Adapter-Network-100Mbps/dp/B07VK8Q36S/).
...
* 当在WiFi环境下使用iPhone与MacBook时， **请务必关闭MacBook的AirDrop**，因为在iPhone靠近Mac时，它**将会**导致大量的延迟峰值。打开控制台并输入：
