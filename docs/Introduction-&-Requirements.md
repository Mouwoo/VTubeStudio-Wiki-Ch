...
请查看常见问题部分的["我该如何购买VTube Studio？"](FAQ.md)。
...
支持任何网络摄像头，画质更好则追踪效果更好。一般而言，为了更好的眼部与眨眼追踪，推荐使用至少1280x720分辨率的摄像头。15-30之间的帧速率足以实现良好的跟踪。部分用户报告，在使用单反相机时会出现问题。