...
![Twitch热键触发器扩展功能界面](img/img/twitch_hotkey_trigger_ex_feature.png)
...
![Twitch热键触发器设置界面1](img/img/twitch_hotkey_trigger_ex_1.png)
...
![Twitch热键触发器设置界面2](img/img/twitch_hotkey_trigger_ex_2.png)
...
![Twitch热键触发器冷却设置界面](img/img/twitch_hotkey_trigger_ex_3.png)
...
![Twitch热键触发器模型加载通知界面](img/img/twitch_hotkey_trigger_ex_4.png)
